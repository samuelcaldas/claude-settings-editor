...
(function exposeSettingsCatalog(root, factory) {
  ...
  const PRESENTATION_CATALOG = {
    ...
    'permissions.allowManagedPermissionRulesOnly': { category: 'permissions', order: 7, labelKey: 'setting.permissions_allowManagedPermissionRulesOnly.label', scopes: ['managed'], managedOnly: true },
    ...
    'disableBypassPermissionsMode': { category: 'permissions', order: 9, labelKey: 'setting.disableBypassPermissionsMode.label', scopes: ['managed'], managedOnly: true },
    ...
    'permissions.skipDangerousModePermissionPrompt': { category: 'permissions', order: 10.5, labelKey: 'setting.permissions_skipDangerousModePermissionPrompt.label', scopes: ['user', 'managed'] },
