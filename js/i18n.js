(function exposeI18n(root, factory) {
  ...
  const DICTIONARIES = {
    en: {
      ...
      'sections.env.title': 'Environment Variables',
      'sections.env.desc': 'Environment variables set in Claude Code sessions and passed to subprocesses, tools, and hooks. Values matching credential patterns are masked by default.',
      'sections.env.presets': 'Quick Presets:',
      'sections.env.helpers': 'Credential & Telemetry Helpers',

      'sections.models.title': 'Models & Dynamic Workflows',
      'sections.models.desc': 'Configure primary model selection, fallback model chains, advisor tool model, extended thinking, and workflow size guidelines.',
      ...
      'env.keyPlaceholder': 'VARIABLE_NAME (e.g. ANTHROPIC_API_KEY)',
      'env.valPlaceholder': 'Value (or empty to unset)',
      'env.empty': 'No environment variables set in settings.',
      ...
      'field.advisorModel.placeholder': 'fable, opus, or sonnet',
    ...
    'pt-BR': {
      ...
      'actions.undoTitle': 'Desfazer alteração',
      'actions.redoTitle': 'Refazer alteração',
      ...
      'sections.env.title': 'Variáveis de Ambiente',
      'sections.env.desc': 'Variáveis de ambiente definidas nas sessões do Claude Code e repassadas para subprocessos, ferramentas e hooks. Valores correspondentes a padrões de credenciais são mascarados por padrão.',
      'sections.env.presets': 'Predefinições Rápidas:',
      'sections.env.helpers': 'Auxiliares de Credenciais e Telemetria',

      'sections.models.title': 'Modelos e Fluxos de Trabalho Dinâmicos',
      'sections.models.desc': 'Configure a seleção do modelo principal, cadeias de modelos de fallback, modelo do assistente, raciocínio estendido e diretrizes de tamanho de fluxo.',
      ...
      'env.keyPlaceholder': 'NOME_VARIAVEL (ex.: ANTHROPIC_API_KEY)',
      'env.valPlaceholder': 'Valor (ou vazio para remover)',
      'env.empty': 'Nenhuma variável de ambiente definida nas configurações.',
      ...
      'field.advisorModel.placeholder': 'fable, opus ou sonnet',
