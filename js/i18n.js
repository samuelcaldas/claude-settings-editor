(function exposeI18n(root, factory) {
  ...
  const DICTIONARIES = {
    en: {
      ...
      'models.discovery.status.noCreds': 'API key required for model discovery.',
      'models.discovery.status.empty': 'No API key configured. Models list is empty.',
    ...
    'pt-BR': {
      ...
      'models.discovery.status.noCreds': 'Chave de API necessária para descoberta de modelos.',
      'models.discovery.status.empty': 'Nenhuma chave de API configurada. A lista de modelos está vazia.',
