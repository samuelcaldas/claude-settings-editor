(function exposeI18n(root, factory) {
  ...
  const DICTIONARIES = {
    en: {
      ...
      'setting.permissions_skipDangerousModePermissionPrompt.label': 'Skip Dangerous Mode Prompt (Nested)',
      'setting.useAutoModeDuringPlan.label': 'Use Auto Mode During Plan',
      ...
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL.label': 'Fable Model ID',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_NAME.label': 'Fable Model Display Name',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION.label': 'Fable Model Description',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_SUPPORTED_CAPABILITIES.label': 'Fable Supported Capabilities',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL.label': 'Opus Model ID',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_NAME.label': 'Opus Model Display Name',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION.label': 'Opus Model Description',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES.label': 'Opus Supported Capabilities',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL.label': 'Sonnet Model ID',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_NAME.label': 'Sonnet Model Display Name',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_DESCRIPTION.label': 'Sonnet Model Description',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES.label': 'Sonnet Supported Capabilities',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL.label': 'Haiku Model ID',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME.label': 'Haiku Model Display Name',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_DESCRIPTION.label': 'Haiku Model Description',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES.label': 'Haiku Supported Capabilities',
      'setting.env_ANTHROPIC_CUSTOM_MODEL_OPTION.label': 'Custom Model Option ID',
      ...
      'setting.switchModelsOnFlag.label': 'Auto Switch Fallback on Safety Flag',
      'setting.autoCompactEnabled.label': 'Auto-compact Context Window',
      'setting.autoCompactWindow.label': 'Auto-compact Token Window',
      'setting.autoCompactThreshold.label': 'Auto-compact Threshold Ratio',
      'setting.workflowKeywordTriggerEnabled.label': 'Workflow Keyword Trigger (ultracode)',
      'setting.disableWorkflows.label': 'Disable Dynamic Workflows',
      ...
      'field.autoCompactThreshold.hint': 'Context capacity ratio that triggers auto-compaction (0.0 to 1.0).',
      'field.autoCompactThreshold.defaultTitle': 'Default ratio (unset)',
      'field.autoCompactThreshold.configuredTitle': 'Configured threshold ratio',
    ...
    'pt-BR': {
      ...
      'setting.permissions_skipDangerousModePermissionPrompt.label': 'Pular Confirmação de Modo Perigoso (Aninhado)',
      'setting.useAutoModeDuringPlan.label': 'Usar Modo Auto Durante o Plano',
      ...
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL.label': 'ID do Modelo Fable',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_NAME.label': 'Nome de Exibição do Modelo Fable',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION.label': 'Descrição do Modelo Fable',
      'setting.env_ANTHROPIC_DEFAULT_FABLE_MODEL_SUPPORTED_CAPABILITIES.label': 'Capacidades Suportadas do Fable',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL.label': 'ID do Modelo Opus',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_NAME.label': 'Nome de Exibição do Modelo Opus',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION.label': 'Descrição do Modelo Opus',
      'setting.env_ANTHROPIC_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES.label': 'Capacidades Suportadas do Opus',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL.label': 'ID do Modelo Sonnet',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_NAME.label': 'Nome de Exibição do Modelo Sonnet',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_DESCRIPTION.label': 'Descrição do Modelo Sonnet',
      'setting.env_ANTHROPIC_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES.label': 'Capacidades Suportadas do Sonnet',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL.label': 'ID do Modelo Haiku',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME.label': 'Nome de Exibição do Modelo Haiku',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_DESCRIPTION.label': 'Descrição do Modelo Haiku',
      'setting.env_ANTHROPIC_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES.label': 'Capacidades Suportadas do Haiku',
      'setting.env_ANTHROPIC_CUSTOM_MODEL_OPTION.label': 'ID da Opção de Modelo Personalizada',
      ...
      'setting.switchModelsOnFlag.label': 'Alternar Fallback Automaticamente em Sinalizador de Segurança',
      'setting.autoCompactEnabled.label': 'Compactação Automática da Janela de Contexto',
      'setting.autoCompactWindow.label': 'Janela de Tokens para Compactação Automática',
      'setting.autoCompactThreshold.label': 'Taxa Limite de Compactação Automática',
      'setting.workflowKeywordTriggerEnabled.label': 'Gatilho de Fluxo por Palavra-Chave (ultracode)',
      'setting.disableWorkflows.label': 'Desativar Fluxos Dinâmicos',
      ...
      'field.autoCompactThreshold.hint': 'Proporção de capacidade de contexto que aciona a compactação automática (0,0 a 1,0).',
      'field.autoCompactThreshold.defaultTitle': 'Taxa padrão (não definida)',
      'field.autoCompactThreshold.configuredTitle': 'Taxa limite configurada',
